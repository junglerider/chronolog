...
INSERT INTO `invoice` (`id`, `invoice_no`, `customer_id`, `status`, `date`, `due_date`, `address`, `issuer`, `headline`, `currency`, `net_total`, `show_tax`, `tax_rate`, `tax_amount`, `grand_total`, `payment_terms`, `created_at`, `updated_at`) VALUES
(1, 'MY-ORG-20-051', 1, 'draft', (SELECT DATE('now', '-6 day')), (SELECT DATE('now', '+14 day')), 'Werthmann AG' || char(13) || 'Mozartstraße 98' || char(13) || '78021 Karlsruhe', 'Maria Hagenkamp', null, 'EUR', 4800, 1, 19, 912, 5712, '20 days', (SELECT DATE('now', '-6 day')), null),
...
(3, 'MY-ORG-20-049', 3, 'paid', (SELECT DATE('now', '-30 day')), (SELECT DATE('now', '-10 day')), 'Banco Santander Logroño' || char(13) || 'Sr. Antonio Ruiz-Orellana' || char(13) || 'Avenida Vera Cruz 98' || char(13) || '39301 Logroño' || char(13) || 'La Rioja, Spain', 'Maria Hagenkamp', 'Software development and consulting services', 'USD', 8500, 1, 21, 1785, 10285, '20 days', (SELECT DATE('now', '-32 day')), null);
